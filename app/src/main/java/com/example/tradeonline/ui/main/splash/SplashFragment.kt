package com.example.tradeonline.ui.main.splash
...
import com.example.tradeonline.data.service.model.FriendlyMessage
import com.example.tradeonline.databinding.FragmentSplashBinding
import com.example.tradeonline.extensions.*
import com.example.tradeonline.ui.main.MainActivity.Companion.remoteCounter
import com.example.tradeonline.ui.main.splash.model.RemoteConfig
...
class SplashFragment :
    ...
    private fun navigateToDashboard(data: RemoteConfig) {
        ...
        if (data.isForceUpdate != true && data.versionAndApp == requireContext().versionApp) {
