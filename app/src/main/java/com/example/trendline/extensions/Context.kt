package com.example.trendline.extensions
...
import com.example.trendline.data.service.model.ErrorMessage
import com.example.trendline.data.service.model.FriendlyMessage
import com.example.trendline.data.service.util.ErrorModel
import com.example.trendline.data.service.util.ExceptionHandle
import com.example.trendline.databinding.DialogDefaultBinding
...
fun Context.openMarket() {
    val uri: Uri = Uri.parse("market://details?id=com.example.trendline")
