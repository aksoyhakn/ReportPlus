...
data class TrayItem(
    ...
    val hideFromFeedUnit: Boolean? = false,
    @SerializedName("seen")
    val seen: Long? = 0,
...
data class CoverMedia(
    @SerializedName("full_image_version")
    val fullImageVersion: CandidatesItem,
    @SerializedName("cropped_image_version")
    val croppedImageVersion: CandidatesItem,
